...
(function (Development) {
   ...
   */
  Development.InputField = function (params, callbacks) {
    var that = this;
   ...
   */
  Development.InputField.prototype.getIntroduction = function () {
   ...
   */
  Development.InputField.prototype.getContent = function () {
    return this.content;
  };
   ...
   */
  Development.InputField.prototype.getText = function () {
   ...
   */
  Development.InputField.prototype.disable = function () {
   ...
   */
  Development.InputField.prototype.enable = function () {
   ...
   * Enable the inputField.
   */
  Development.InputField.prototype.focus = function () {
   ...
   */
  Development.InputField.prototype.setText = function (previousState) {
   ...
   */
  Development.InputField.prototype.computeRemainingChars = function () {
   ...
   */
  Development.InputField.prototype.updateMessageChars = function () {
   ...
   */
  Development.InputField.prototype.updateMessageSaved = function (saved) {
    if (!this.params.statusBar) {
      return;
    }
   ...
   */
  Development.InputField.prototype.setMessageChars = function (message, important) {
    if (!this.params.statusBar) {
      return;
    }
